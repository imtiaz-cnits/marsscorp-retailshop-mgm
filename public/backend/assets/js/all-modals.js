...
// All Modals Helper Scripts with Strict Null-Safety
document.addEventListener("DOMContentLoaded", () => {
    // Generic safe modal binder
    function bindSimpleModal(modalSelector, openSelector, closeSelector, cancelSelector) {
