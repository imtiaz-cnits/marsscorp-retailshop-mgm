    ...
    <script>
        ...
        async function getList() {
            try {
                ...
                let res = await axios.get("/api/category-list", HeaderToken()); // Fetch brand list
                ...
                res.data['CategoryData'].forEach(function (item, index) {
                    const img_url = item['img_url'] ? item['img_url'] : "{{ asset('back-end/assets/img/category-defult-img.svg') }}";
            ...
            <i class="fa-solid fa-trash"></i>
                            ...
                            <td><img style="width: 60px; height: auto" alt="" src="${img_url}"></td>
