        ...
        <div class="bill-main-body">
            ...
            <div class="header-top">
                <div class="brand-logo-box d-flex align-items-center">
                    <img src="{{ asset('back-end/assets/icons/marss-corporation-icon.svg') }}" alt="MARSS Corporation Logo" style="height: 52px; width: 52px; object-fit: contain; margin-right: 10px;" />
