        ...
        <div class="page-content">
            ...
            <div class="bredcam">
                <div class="bredcam-title">
                    <h1>Customer Due Collection List</h1>
                </div>
            </div>
    ...
    <script>
        ...
        async function getList() {
            try {
                ...
                let res = await axios.get("/api/admin-dashboard-customer-due-collection", HeaderToken()); // Fetch data
                ...
                res.data['CustomerDueCollectionData'].forEach(function (item, index) {
                    ...
                    let row = `
                        <tr data-row="${index + 1}">
                            <td>${index + 1}</td>
                            <td style="text-wrap: nowrap;">${formatDate(item.due_collection_date)}</td>
                            <td style="text-wrap: nowrap;">${customerID}</td>
                            <td style="text-wrap: nowrap;">${customerName}</td>
