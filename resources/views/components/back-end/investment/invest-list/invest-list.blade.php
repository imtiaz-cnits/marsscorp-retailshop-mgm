                            ...
                            <table id="printTable" class="table table-bordered table-hover">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td id="subTotal" colspan="2">0.00 TK</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
    ...
    <script>
        ...
        async function getList(startDate = '', endDate = '') {
            try {
                ...
                const url = `/api/invest-list?start_date=${startDate}&end_date=${endDate}`;
                const response = await axios.get(url, HeaderToken());
                hideLoader(); // Hide loading indicator

                // Ensure response contains data
                const InvestData = response.data.InvestData || [];
                const subTotal = response.data.subTotal || 0;

                // Update table and subtotal
                const tableList = $('#tableList');
                const subTotalElement = $('#subTotal');
                tableList.empty(); // Clear existing rows
                                                ...
                                                <ul>
                                                    <li>
                                                        <button  data-id="${item['id']}"
                                                           ...
                                                           data-modal="action-editmodal">Edit</button>
                                                    </li>
                                                    <li>
                                                        <button data-id="${item['id']}"
                ...
                // Update subtotal
                subTotalElement.text(`${subTotal.toFixed(2)} TK`);
