...
text-align: center;
    ...
    .data-table .table thead th:nth-child(1) {
width: 40px;
    }
   </style>
    ...
    <script>
        ...
        async function getList() {
            try {
                ...
                let res = await axios.get("/api/district-list", HeaderToken()); // Fetch brand list
                hideLoader(); // Hide loader after response

                let tableList = $("#tableList");
                tableList.empty(); // Clear previous table content

                res.data['DistrictData'].forEach(function(item, index) {
