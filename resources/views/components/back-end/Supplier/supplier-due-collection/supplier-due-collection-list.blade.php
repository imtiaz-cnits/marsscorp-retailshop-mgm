        ...
        <div class="page-content">
            ...
            <div class="bredcam">
                <div class="bredcam-title">
                    <h1>Supplier Due Collection List</h1>
                </div>
            </div>
                            ...
                            <table id="printTable" class="table table-bordered table-hover">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th id="subTotalPayable">0.00</th>
                                        <th id="subTotalPaid">0.00</th>
                                        <th id="subTotalDue">0.00</th>
                                        <th></th>
                                    </tr>
                                </tfoot>
                            </table>
    ...
    <script>
        ...
        async function getList() {                                                            
            try {
                ...
                let res = await axios.get("/api/admin-dashboard-supplier-due-collection", HeaderToken()); // Fetch data
                ...
                res.data['SupplierDueCollectionData'].forEach(function (item, index) {
                    ...
                    let row = `
                        <tr data-row="${index + 1}">
                            <td>${index + 1}</td>
                            <td style="text-wrap: nowrap;">${formatDate(item.created_at)}</td>
                            <td style="text-wrap: nowrap;">${supplierID}</td>
                            <td style="text-wrap: nowrap;">${supplierName}</td>
                            <td>${payableAmount.toFixed(2)}</td>
                            <td>${paidAmount.toFixed(2)}</td>
                            <td>${dueAmount.toFixed(2)}</td>
                            <td>
                                <span class="badge badge-${paymentStatus === 'Fully Paid' ? 'success' : paymentStatus === 'Partial Paid' ? 'warning' : paymentStatus === 'Unpaid' ? 'danger' : 'secondary'}">${paymentStatus}</span>
                            </td>
                        </tr>`;
                ...
                // Update subtotal fields in the footer
                $("#subTotalPayable").text(subTotalPayable.toFixed(2) + " TK");
                $("#subTotalPaid").text(subTotalPaid.toFixed(2) + " TK");
                $("#subTotalDue").text(subTotalDue.toFixed(2) + " TK");
