                ...
                <div class="card-body">
                    <div class="button-wrapper mb-3">
                        ...
                        <div class="button-item">
                            <button id="openModalBtns" type="button" class="create-invoice" data-bs-toggle="modal" data-bs-target="#brandCreateModal">
                                + Create Brand
                            </button>
...
<script>
    ...
    function renderPaginatedList() {
        ...
        // 1. Filter Brands
        let filtered = rawBrandData.filter(function(item) {
        ...
        if (pageItems.length === 0) {
            tableList.html('<tr><td colspan="5" class="text-center text-danger p-4 fw-bold">❌ কোনো ব্র্যান্ড পাওয়া যায়নি।</td></tr>');
            mobileCardList.html('<div class="p-4 text-center text-danger fw-bold bg-white rounded-3 border shadow-sm">❌ কোনো ব্র্যান্ড পাওয়া যায়নি।</div>');
        } else {
            pageItems.forEach(function(item, idx) {
                let realIndex = startIndex + idx;
                let logo = item.logo ? (item.logo.startsWith('http') ? item.logo : '/' + item.logo.replace(/^\/+/, '')) : "{ asset('back-end/assets/img/brand-defult-img.svg') }";
                    ...
                    <tr data-row="${realIndex + 1}">
                        ...
                        <td class="text-center">
                            <div class="d-flex align-items-center justify-content-center gap-1">
                                <button type="button" data-id="${item.id}" class="edit-link btn btn-sm btn-outline-success rounded-circle d-flex align-items-center justify-content-center p-0" data-bs-toggle="modal" data-bs-target="#brandUpdateModal" title="Edit Brand" style="width: 32px; height: 32px;">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </button>
                                <button type="button" data-id="${item.id}" class="custom-delete-modal-btn btn btn-sm btn-outline-danger rounded-circle d-flex align-items-center justify-content-center p-0" data-bs-toggle="modal" data-bs-target="#brandDeleteModal" title="Delete Brand" style="width: 32px; height: 32px;">
                                    <i class="fa-solid fa-trash"></i>
                                </button>
                            </div>
                        </td>
                        <td class="text-center">
                            <img style="width: 45px; height: 45px; object-fit: contain;" class="rounded-3 border shadow-sm p-1 bg-white" alt="${item.name}" src="${logo}" onerror="this.src='{ asset('back-end/assets/img/brand-defult-img.svg') }'">
                        </td>
                        <td class="text-start">
                ...
                // Mobile Card View
                let mobileCard = `
                    <div class="brand-mobile-card card border shadow-sm rounded-4 mb-3 p-3 position-relative bg-white">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-2">
                            <img src="${logo}" class="rounded-3 border shadow-sm p-1 bg-white" style="width: 48px; height: 48px; object-fit: contain;" onerror="this.src='{ asset('back-end/assets/img/brand-defult-img.svg') }'">
                            <div>
                        ...
                        <div class="d-flex align-items-center justify-content-end gap-2 pt-2 mt-1 border-top">
                            <button type="button" data-id="${item.id}" class="edit-link btn btn-sm btn-outline-success rounded-circle d-flex align-items-center justify-content-center p-0" data-bs-toggle="modal" data-bs-target="#brandUpdateModal" title="Edit Brand" style="width: 34px; height: 34px;">
                                <i class="fa-solid fa-pen-to-square fs-6"></i>
                            </button>
                            <button type="button" data-id="${item.id}" class="custom-delete-modal-btn btn btn-sm btn-outline-danger rounded-circle d-flex align-items-center justify-content-center p-0" data-bs-toggle="modal" data-bs-target="#brandDeleteModal" title="Delete Brand" style="width: 34px; height: 34px;">
