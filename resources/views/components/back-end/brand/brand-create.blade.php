                ...
                <form id="createBrandForm" onsubmit="BrandDataSave(event)">
                    ...
                    <div class="card border-0 shadow-sm rounded-3 p-3 mb-3 text-center bg-white">
                        <div class="d-inline-block position-relative mb-2">
                            <img id="createBrandShowImage" src="{{ asset('back-end/assets/img/brand-defult-img.svg') }}" alt="Brand Logo Preview" style="width: 85px; height: 85px; object-fit: contain; border-radius: 12px; border: 2px dashed #86efac; padding: 4px; background: #f0fdf4;" />
                        </div>
                        <div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        $('#brandCreateModal').on('hidden.bs.modal', function () {
            ...
            $('#createBrandShowImage').attr('src', "{{ asset('back-end/assets/img/brand-defult-img.svg') }}");
        });
    });
