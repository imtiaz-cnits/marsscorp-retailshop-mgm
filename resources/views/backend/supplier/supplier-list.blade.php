                ...
                pageItems.forEach(function (item, idx) {
                    ...
                    let row = `
                        <tr data-row="${realIndex + 1}">
                            ...
                            <td class="text-center">
                                <img style="width: 45px; height: 45px; object-fit: cover;" class="rounded-circle border shadow-sm" alt="${item['name']}" src="${img_url}" onerror="this.src='{{ asset('backend/assets/img/demo-img.jpeg') }}'">
                            </td>
                            <td>
                    ...
                    let mobileCard = `
                        <div class="supplier-mobile-card card border shadow-sm rounded-4 mb-3 p-3 position-relative bg-white">
                            ...
                            <div class="d-flex align-items-center gap-3 mb-2">
                                <img src="${img_url}" class="rounded-circle border shadow-sm" style="width: 48px; height: 48px; object-fit: cover;" onerror="this.src='{{ asset('backend/assets/img/demo-img.jpeg') }}'">
                                <div>
