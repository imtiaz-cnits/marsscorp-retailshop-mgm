    ...
    <table id="printTable" class="table table-bordered table-hover">
        ...
        <tfoot>
            <tr>
                ...
                <td id="totalPayableaamountPrice">৳ 0.00</td>
                <td id="totalDueAmountPrice">৳ 0.00</td> <!-- New Total -->
                <td></td>
            </tr>
        </tfoot>
    </table>
   ...
   <script>
    ...
    async function getList() {
        try {
            ...
            let res = await axios.get("/api/supplier-due-list", HeaderToken()); // Fetch supplier list

            hideLoader(); // Hide loader after response

            let tableList = $("#tableList");
            let totalPayableAmount = 0; // Initialize total payable amount
            ...
            res.data['SupplierData'].forEach(function(item, index) {
                ...
                let row = `
                    <tr data-row="${index + 1}">
                        ...
                        <td>${totalDue.toFixed(2)}</td> <!-- Due Amount Column -->
                        <td>${(payableAmount + totalDue).toFixed(2)}</td>
                        <td>${item['status']}</td>
                    </tr>
                `;
            ...
            $("#totalDueAmountPrice").text(`৳ ${totalDueAmount.toFixed(2)}`);
            ...
            // If you have delete buttons, bind here
