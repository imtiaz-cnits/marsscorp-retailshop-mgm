            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                <div>
                    <h3 class="fw-bold text-dark mb-1">
                        <i class="fa-solid fa-user-tie text-success me-2"></i> Staff Salary Profile
                    </h3>
                    <p class="text-muted small mb-0">Staff salary history and related salary report</p>
                </div>
                <a href="{{ url('/admin-dashboard-expence-list') }}" class="btn btn-outline-secondary fw-semibold rounded-pill px-4 shadow-sm">
                    <i class="fa-solid fa-arrow-left me-1"></i> Back to Expense List
                </a>
            </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 h-100 bg-white" style="border-left: 4px solid #16a34a !important;">
                        <div class="card-body p-3 d-flex align-items-center gap-3">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                <small class="text-muted fw-semibold">Staff Name & Role</small>
                                <h5 class="fw-bold text-dark text-truncate mb-0" id="staffName">Loading...</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 shadow-sm rounded-4 h-100 bg-white" style="border-left: 4px solid #0284c7 !important;">
                        <div class="card-body p-3 d-flex align-items-center gap-3">
                            ...
                            <div>
                                <small class="text-muted fw-semibold">Contact Details</small>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card border-0 shadow-sm rounded-4 h-100 text-white" style="background: linear-gradient(135deg, #15803d 0%, #16a34a 100%);">
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                <small class="text-white-50 fw-bold">Total Paid Salary</small>
                                <h2 class="fw-extrabold text-white my-1" id="totalStaffSalary">৳ 0.00</h2>
                                <small class="text-white-50"><i class="fa-solid fa-circle-check me-1"></i> Total Salary Entries: <span id="totalSalaryCount">0</span></small>
                            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden">
                <div class="card-header bg-white py-3 px-4 d-flex flex-wrap align-items-center justify-content-between gap-3 border-bottom-0">
                    <h5 class="fw-bold mb-0 text-dark">
                        <i class="fa-solid fa-receipt text-success me-2"></i> Salary Payment History
                    </h5>
                    <div class="position-relative" style="min-width: 250px;">
                        <input type="text" id="salarySearch" class="form-control rounded-pill pe-4 ps-4" placeholder="🔍 Search..." onkeyup="filterSalaryTable()" />
                    </div>
                </div>
                            ...
                            <tbody id="salaryTableBody">
                                <tr>
                                    <td colspan="5" class="text-center py-4 text-muted">
                                        <i class="fa-solid fa-circle-notch fa-spin me-2"></i> Loading staff salary data...
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<script>
    ...
    async function fetchStaffProfileData() {
        ...
        try {
            ...
            errorToast('Failed to load staff salary data');
        }
    }
            ...
            tbody.innerHTML = `
                <tr>
                    <td colspan="5" class="text-center py-4 text-muted">
                        ...
                        No salary payment records found for this staff yet.
                    </td>
                </tr>
            `;
            return;
        ...
        data.forEach((item, index) => {
            ...
            const row = `
                <tr>
                    ...
                    <td class="text-secondary small">${item.expense_details || 'Salary Payment'}</td>
