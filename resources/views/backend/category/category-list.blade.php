...
<script>
    ...
    function renderPaginatedList() {
        ...
        if (pageItems.length === 0) {
            tableList.html('<tr><td colspan="5" class="text-center text-rose-500 font-bold p-8 dark:text-rose-400">❌ কোনো ক্যাটাগরি পাওয়া যায়নি।</td></tr>');
            mobileCardList.html('<div class="p-6 text-center text-rose-500 dark:text-rose-400 font-bold bg-white dark:bg-slate-800 rounded-2xl border border-slate-300 dark:border-slate-800 shadow-sm">❌ কোনো ক্যাটাগরি পাওয়া যায়নি।</div>');
        } else {
