    ...
    <script>
        ...
        async function getList() {
            try {
                ...
                let res = await axios.get("/api/sub-category-list", HeaderToken()); // Fetch brand list
                hideLoader(); // Hide loader after response

                let tableList = $("#tableList");
                tableList.empty(); // Clear previous table content

                res.data['SubCategoryData'].forEach(function(item, index) {
            ...
            <a href="#"
            data-id="${item['id']}"
            class="link custom-delete-modal-btn"
            data-bs-toggle="modal"
