                            ...
                            <table id="printTable" class="table table-bordered table-hover align-middle">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-start text-nowrap" style="min-width: 130px;">Customer ID</th>
...
<script>
    ...
    function renderPaginatedList() {
        ...
        if (pageItems.length === 0) {
            tableList.html('<tr><td colspan="8" class="text-center text-danger p-4 fw-bold">❌ No customers found.</td></tr>');
            mobileCardList.html('<div class="p-4 text-center text-danger fw-bold bg-white rounded-3 border shadow-sm">❌ No customers found.</div>');
        } else {
                ...
                let row = `
                    <tr data-row="${realIndex + 1}">
                        ...
                        <td class="text-nowrap">
                            <a href="/customer/profile/${item['id']}" class="fw-bold text-success text-decoration-none text-nowrap" style="white-space: nowrap;">
                                <i class="fa-solid fa-user me-1"></i>${item['customer_id'] ?? 'N/A'}
                            </a>
                        </td>
                        <td class="text-center">
                            <img style="width: 45px; height: 45px; object-fit: cover;" class="rounded-circle border shadow-sm" alt="${item['customer_name']}" src="${img_url}" onerror="this.src='{{ asset('backend/assets/img/brand-defult-img.svg') }}'">
                        </td>
                        <td>
                ...
                let mobileCard = `
                    <div class="customer-mobile-card card border shadow-sm rounded-4 mb-3 p-3 position-relative bg-white">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-2">
                            <img src="${img_url}" class="rounded-circle border shadow-sm" style="width: 48px; height: 48px; object-fit: cover;" onerror="this.src='{{ asset('backend/assets/img/brand-defult-img.svg') }}'">
                            <div>
                                <h6 class="fw-bold text-dark mb-0" style="font-size: 14px;">${item['customer_name']}</h6>
                        ...
                        <div class="bg-light p-2 rounded-3 my-2 d-flex align-items-center justify-content-between" style="border: 1px solid #f1f5f9;">
                            <span class="text-muted small fw-bold" style="font-size: 11px;">Total Due:</span>
