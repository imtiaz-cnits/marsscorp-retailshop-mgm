                    ...
                    <div class="card-body">
                        ...
                        <div class="table-wrapper" style="overflow: scroll">
                            <table id="printTable" class="table table-bordered table-hover">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="5" style="text-align: right; font-weight: bold;">Total Previous Due:</td>
                                        <td id="total_previous_due_amount">0</td>
                                        <td id="total_order_due_amount">0</td>
                                        <td id="total_total_due_amount">0</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
    ...
    async function getList() {
        try {
            ...
            if (res.data.status === "success" && Array.isArray(res.data.CustomerData)) {
                res.data.CustomerData.forEach((item, index) => {
                    const img_url = item.img_url ? item.img_url :
                        "{{ asset('backend/assets/img/brand-defult-img.svg') }}";
                    ...
                    totalPreviousDue += previous_due;
                    totalOrderDue += order_due;
                    totalTotalDue += total_due;
                        ...
                        <tr>
                            ...
                            <td>
                                <div id="action_btn_wrap">
                                    <a data-id="${item['id']}" href="#" class="link edit-link" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <a href="#" data-id="${item['id']}" class="link custom-delete-modal-btn" data-bs-toggle="modal" data-bs-target="#confirmationModal">
                            ...
                            <td>${item.mobile}</td>
                            <td>${previous_due.toFixed(2)}</td>
                            <td>${order_due.toFixed(2)}</td>
                ...
                $("#total_previous_due_amount").text(totalPreviousDue.toFixed(2));
                $("#total_order_due_amount").text(totalOrderDue.toFixed(2));
                $("#total_total_due_amount").text(totalTotalDue.toFixed(2));
