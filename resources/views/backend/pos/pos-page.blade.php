...
<head>
    ...
    <style>
        ...
        /* 7. SUB-TOTAL Card in Light & Dark Mode */
...
<body>
            ...
            <div class="nav-wrapper py-1 px-2 px-md-3 d-flex align-items-center justify-content-between gap-1 gap-md-2" style="min-height: 42px; border-radius: 12px; flex-wrap: nowrap;">
                ...
                <div class="store-brand-header d-flex align-items-center gap-1 gap-md-2 px-2 px-md-3 py-1 bg-white border-0 rounded-pill overflow-hidden" style="border: none !important;">
                    ...
                    <h5 class="fw-extrabold text-success m-0 p-0 d-flex align-items-center gap-1 text-truncate" style="font-size: 13px; font-family: 'Baloo Da 2', sans-serif; font-weight: 800;">
                        <span class="text-truncate">MARSS CORPORATION</span>
                    ...
                    <div class="row g-1.5 align-items-center">
                        ...
                        <div class="col-md-5 col-12">
                            <div class="d-flex align-items-center gap-1">
                                <span class="text-muted small text-nowrap fw-bold" style="font-size: 12px;">Date:</span>
                    ...
                    <div class="row g-1 mt-1 pt-1 border-top align-items-center">
                        <div class="col-md-4 col-6">
                            <div class="input-group input-group-sm">
                                <span class="input-group-text bg-light py-0 px-1.5 fw-bold pos-th-styled-label" style="font-size: 14px !important; font-weight: 800 !important; color: #475569; letter-spacing: 0.3px;">Name</span>
                                <input type="text" id="CustomerName" readonly class="form-control py-0 px-1.5 fw-bold text-dark" placeholder="Customer Name" style="font-size: 12px; height: 26px; background: #f8fafc;" />
                                <input type="hidden" id="CustomerID" value="" />
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="input-group input-group-sm">
                                <span class="input-group-text bg-light py-0 px-1.5 fw-bold pos-th-styled-label" style="font-size: 14px !important; font-weight: 800 !important; color: #475569; letter-spacing: 0.3px;">Mobile</span>
                                <input type="text" id="CustomerMobileNumber" readonly class="form-control py-0 px-1.5 fw-bold text-dark" placeholder="Mobile" style="font-size: 12px; height: 26px; background: #f8fafc;" />
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="input-group input-group-sm">
                                <span class="input-group-text bg-light py-0 px-1.5 fw-bold pos-th-styled-label" style="font-size: 14px !important; font-weight: 800 !important; color: #475569; letter-spacing: 0.3px;">Address</span>
                                <input type="text" id="CustomerAddress" readonly class="form-control py-0 px-1.5 text-dark" placeholder="Address" style="font-size: 12px; height: 26px; background: #f8fafc;" />
                            </div>
                        </div>
                        <div class="col-md-2 col-6">
                            <div class="input-group input-group-sm">
                                <span class="input-group-text bg-danger-subtle text-danger py-0 px-1 fw-bold pos-th-styled-label" style="font-size: 14px !important; font-weight: 800 !important; color: #dc2626; letter-spacing: 0.3px;">Due</span>
                        ...
                        <div class="row g-1.5 align-items-center">
                            ...
                            <div class="col-12 col-lg-4 mb-1.5 mb-lg-0">
                                <div class="d-flex gap-1.5 w-100">
                                    <button type="button" onclick="holdCurrentInvoice()" class="btn btn-warning flex-fill py-1.5 d-flex align-items-center justify-content-center gap-1 fw-bold text-dark shadow-sm" style="border-radius: 8px; background: #f59e0b; border: none; font-size: 12px; height: 38px; color: #0f172a !important;">
                                        ...
                                        <span style="color: #0f172a !important;">Hold</span>
                                    </button>
                                    <button type="button" onclick="openHoldInvoicesModal()" class="btn btn-outline-warning flex-fill py-1.5 px-2 d-flex align-items-center justify-content-center gap-1.5 fw-bold" style="border-radius: 8px; font-size: 12px; height: 38px; border-color: #f59e0b; color: #f59e0b;" title="Held Invoices List">
                            ...
                            <div class="col-6 col-lg-4">
                                <div class="pos-big-subtotal-card py-1 px-1.5 text-center border rounded-2 shadow-xs d-flex flex-column justify-content-center" style="border-radius: 8px; height: 38px;">
                                    <span class="pos-big-subtotal-label text-muted d-block small fw-bold text-uppercase" style="font-size: 12px; letter-spacing: 0.3px; line-height: 1;">SUB-TOTAL</span>
                            ...
                            <div class="col-6 col-lg-4">
                                <button type="submit" onclick="SavePaymentInfo(event)" class="btn btn-success w-100 py-2 fw-bold text-white shadow d-flex align-items-center justify-content-center gap-1" style="border-radius: 8px; background: linear-gradient(135deg, #15803d 0%, #16a34a 100%); border: none; font-size: 12.5px; height: 38px; letter-spacing: 0.3px;">
                                    <i class="fa-solid fa-paper-plane me-1"></i> Submit Order
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="d-block d-lg-none position-fixed bottom-0 start-50 translate-middle-x w-100 p-2" style="z-index: 1060; max-width: 540px;">
            <div class="p-2 bg-dark text-white rounded-4 shadow-lg border border-secondary d-flex align-items-center justify-content-between" style="backdrop-filter: blur(14px); background: rgba(15, 23, 42, 0.95) !important;">
                <div class="d-flex align-items-center gap-2 ps-2">
                    ...
                    <div>
                        <span class="d-block text-muted" style="font-size: 12px; line-height: 1;">Total Items</span>
                ...
                <button type="button" id="mobileDockTabBtn" onclick="switchMobilePosTab('cart')" class="btn btn-success fw-bold px-3 py-2 text-nowrap d-flex align-items-center gap-1" style="border-radius: 12px; font-size: 13px; background: linear-gradient(135deg, #15803d 0%, #16a34a 100%); border: none;">
                    <span id="mobileDockTabBtnText">View Cart</span>
            ...
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px; overflow: hidden; background: #f8fafc;">
                <div class="modal-header py-3 px-4" style="background: linear-gradient(135deg, #15803d 0%, #16a34a 100%); border-bottom: none;">
                    <h5 class="modal-title fw-bold text-white m-0 d-flex align-items-center gap-2" id="holdInvoicesModalLabel" style="color: #ffffff !important;">
                        ...
                        <span style="color: #ffffff !important;">Held Invoices List</span>
                    </h5>
                ...
                <div class="modal-footer bg-white py-2 px-3 justify-content-between border-top">
                    <span class="text-muted small"><i class="fa-solid fa-circle-info me-1 text-info"></i> Click 'Load' anytime to load a held invoice to the screen.</span>
                    <button type="button" class="btn btn-danger px-4 fw-bold shadow-sm text-white" data-bs-dismiss="modal" style="border-radius: 10px; background-color: #dc2626 !important; border-color: #dc2626 !important; color: #ffffff !important; height: 38px !important; min-height: 38px !important; display: inline-flex; align-items: center; justify-content: center;">Close</button>
                </div>
            </div>
        </div>
    </div>
            ...
            try {
                ...
                const customerOptions = res.data.CustomerData.map((customer) => {
                    ...
                    <div class="dropdown-item"
                        ...
                        ${activeDue > 0 ? `<span class="badge bg-danger-subtle text-danger border border-danger-subtle flex-shrink-0 fw-bold" style="font-size: 12px; font-weight: 700; padding: 2px 6px;">Due: ৳${activeDue}</span>` : ''}
                    </div>`;
                }).join('');
    ...
    <script>
        ...
        function renderProducts(products, limit = 25) {
            ...
            if (!products || !products.length) {
                $("#ProductCategoryWishDataItem").html('<div class="col-12 text-center text-muted p-4 fw-bold">❌ No products found.</div>');
                return;
            }
                ...
                const loadMoreBtn = `
                    <div class="col-12 text-center my-3" id="loadMoreProductsContainer">
                        <button type="button" class="btn btn-outline-success fw-bold px-4 py-2 shadow-sm" onclick="renderProducts(allProducts, ${limit + 25})" style="border-radius: 20px; font-size: 13px;">
                            <i class="fa-solid fa-plus-circle me-1"></i> Show 25 more products (${remaining} remaining)
                        </button>
                    </div>
                `;
        ...
        function addProductToCart(productId, isFromBarcodeScan = false) {
            ...
            if (!product) {
                Swal.fire({
                    ...
                    text: 'Product not found in system.',
               ...
               onclick="selectProductFromSuggestion(${product.id})">
                <div class="d-flex align-items-center gap-2 overflow-hidden me-2">
                    ...
                    <div class="text-truncate">
                        ...
                        <div class="text-muted small text-truncate" style="font-size: 12px;">Code: <span class="fw-semibold text-secondary">${codeText}</span></div>
                    </div>
                </div>
        ...
        `;
            ...
            <div class="p-2 text-center text-muted small bg-light fw-bold" style="font-size: 12px;">
                💡 Total ${matchingProducts.length} products found
            </div>
        `;
            }
            ...
            if (event.key === "Enter" || event.keyCode === 13) {
                ...
                if (matchingProducts.length === 1) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Product Not Found',
                        text: `Product with code "${cleanValue}" was not found.`,
                        confirmButtonColor: '#15803d'
                    });
                    resetAndFocusSearchBox();
                }
        ...
        function renderCart() {
            ...
            cartItems.forEach((item, index) => {
                ...
                <tr style="border-bottom: 1px solid #f1f5f9;">
                    ...
                    <td style="padding: 5px 2px; vertical-align: middle; text-align: center;">
                        <button type="button" onclick="removeProduct(${item.id})" class="btn-cart-delete" title="Remove">
        ...
        function switchMobilePosTab(tabName) {
            ...
            if (tabName === 'products') {
                ...
                if (dockBtnText) dockBtnText.textContent = "View Cart";
        ...
        function decreaseQuantity(index) {
            if (cartItems[index].quantity > 1) {
                ...
                Swal.fire({
                    ...
                    text: 'Quantity cannot be less than 1. Click delete button to remove.',
                    confirmButtonColor: '#15803d'
                });
            }
        }
        ...
        function updateSellingPrice(productId, inputField) {
            const item = cartItems.find((item) => item.id === productId);
            if (item) {
                // 1. Update value in data object
                item.sellingPrice = parseFloat(inputField.value) || 0;

                // 2. Update calculation without re-rendering table
                // Prevents cursor jumping and decimal issues
                updateTotal();
            }
        }
        ...
        function calculateDuePayment() {
            ...
            if (effectivePaid >= totalTarget && totalTarget > 0) {
                ...
                paymentStatusDisplay.textContent = "Due";
        ...
        function holdCurrentInvoice() {
            if (!cartItems || cartItems.length === 0) {
                Swal.fire({
                    icon: 'warning',
                    title: 'Cart is Empty',
                    text: 'No products in cart to hold.',
                    confirmButtonColor: '#15803d'
                });
                return;
            }
        ...
        function openHoldInvoicesModal() {
            ...
            <div class="text-center text-muted py-5 fw-bold bg-white rounded-3 border">
                ...
                <span>No held invoices found.</span>
            </div>`;
            } else {
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        ...
                        <div class="d-flex align-items-center gap-3 ms-auto ms-sm-0">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <button type="button" class="btn btn-outline-danger px-3 py-2 shadow-xs" onclick="deleteHeldInvoice('${item.id}')" style="border-radius: 10px;" title="Delete">
                                    <i class="fa-solid fa-trash-can"></i>
                                </button>
                            </div>
                        </div>
        ...
        function restoreHeldInvoice(holdId) {
            ...
            if (cartItems.length > 0) {
                Swal.fire({
                    ...
                    text: 'Current cart items will be replaced by the held invoice.',
                    icon: 'question',
        ...
        function applyRestoreHeldInvoice(item, holdId) {
            ...
            if (typeof successToast === 'function') {
                successToast(`▶️ Invoice #${holdId} loaded.`);
            }
        }
        ...
        function deleteHeldInvoice(holdId, showNotice = true) {
            ...
            if (showNotice) {
                ...
                if (typeof successToast === 'function') {
                    successToast(`🗑️ Invoice #${holdId} deleted.`);
                }
            }
        }
            ...
            try {
                ...
                if (cartItems.length === 0) {
                    return Swal.fire({
                        icon: 'warning',
                        title: 'Cart is Empty!',
                        text: 'Add at least one product to cart to place order.',
                        confirmButtonColor: '#15803d'
                    });
                }

                // If paidAmount is 0 (100% Due bill), payment method selection is NOT mandatory!
                ...
                if (!paymentMethod && paidAmount > 0) {
                    return Swal.fire({
                        ...
                        text: 'Please select a payment method (e.g. Cash, bKash) since paid amount is entered.',
                        confirmButtonColor: '#15803d'
                    });
                }
                ...
                if (res.data.status === "success") {
                    Swal.fire({
                        ...
                        text: 'Redirecting to invoice print page...',
                        timer: 1500,
                        showConfirmButton: false
                    }).then(() => {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Order Failed',
                        text: res.data.message || 'Error occurred while processing order.',
                        confirmButtonColor: '#15803d'
                    });
                }
            } catch (error) {
            ...
            <div class="modal-content border-0 shadow-lg" style="border-radius: 18px; overflow: hidden;">
                <div class="modal-header text-white py-3" style="background: linear-gradient(135deg, #15803d 0%, #16a34a 100%);">
                    <h5 class="modal-title fw-bold" id="cameraScanModalLabel">
                        <i class="fa-solid fa-camera me-2"></i> Mobile Camera Barcode Scanner
                    </h5>
                ...
                <div class="modal-body p-3 text-center">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-3 px-1">
                        <span id="lastScannedText" class="badge bg-success fs-6 py-2 px-3" style="border-radius: 10px;">Scanned Code: -</span>
                ...
                <div class="modal-footer bg-light py-2 justify-content-between">
                    <small class="text-muted"><i class="fa-solid fa-bolt text-warning me-1"></i> Scanned barcode will be added to cart automatically</small>
            ...
            <div class="modal-content border-0 shadow-lg" style="border-radius: 14px; overflow: visible;">
                <div class="modal-header py-2.5 px-3" style="background: linear-gradient(135deg, #15803d 0%, #16a34a 100%); border-top-left-radius: 14px; border-top-right-radius: 14px;">
                    <h5 class="modal-title fw-bold text-white mb-0" id="quickAddProductModalLabel" style="color: #ffffff !important; font-size: 15px;">
                        <i class="fa-solid fa-cart-plus me-2" style="color: #ffffff !important;"></i> Quick Create Product from POS
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-3 bg-light" style="overflow: visible; border-bottom-left-radius: 14px; border-bottom-right-radius: 14px;">
                    <form id="quickProductForm" onsubmit="quickSaveProduct(event)">
                        <div class="row g-2.5">
                            <div class="col-md-7">
                                <label for="quickProductName" class="form-label fw-bold text-dark mb-1" style="font-size: 12px;">Product Name <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <label class="form-label fw-bold text-dark mb-1" style="font-size: 12px;">Category</label>
                                <div class="custom-searchable-select" id="quickCategoryDropdown">
                                    ...
                                    <div class="select-trigger d-flex align-items-center justify-content-between px-2.5" onclick="toggleCustomDropdown('quickCategoryDropdown')">
                                        <span class="selected-text text-truncate" style="font-size: 12px; font-weight: 600; color: #64748b;">Select</span>
                                    ...
                                    <div class="select-menu">
                                        <div class="search-wrap">
                                            ...
                                            <input type="text" placeholder="Search category..." oninput="filterCustomDropdown('quickCategoryDropdown', this.value)">
                                        </div>
                            ...
                            <div class="col-md-4">
                                <label class="form-label fw-bold text-dark mb-1" style="font-size: 12px;">Brand</label>
                                <div class="custom-searchable-select" id="quickBrandDropdown">
                                    ...
                                    <div class="select-menu">
                                        <div class="search-wrap">
                                            <i class="fa-solid fa-magnifying-glass position-absolute text-muted" style="top: 50%; transform: translateY(-50%); left: 10px; font-size: 12px;"></i>
                                            <input type="text" placeholder="Search brand..." oninput="filterCustomDropdown('quickBrandDropdown', this.value)">
                                        </div>
                                        <div class="select-options-list">
                            ...
                            <div class="col-md-4">
                                <label class="form-label fw-bold text-dark mb-1" style="font-size: 12px;">Unit</label>
                                <div class="custom-searchable-select" id="quickUnitDropdown">
                                    ...
                                    <div class="select-menu">
                                        <div class="search-wrap">
                                            <i class="fa-solid fa-magnifying-glass position-absolute text-muted" style="top: 50%; transform: translateY(-50%); left: 10px; font-size: 12px;"></i>
                                            <input type="text" placeholder="Search unit..." oninput="filterCustomDropdown('quickUnitDropdown', this.value)">
                                        </div>
                                        <div class="select-options-list">
    ...
    <script>
        ...
        function initHtml5QrCode() {
            ...
            html5QrCode.start({
                ...
                if (statusEl) {
                    ...
                    statusEl.innerHTML = '<i class="fa-solid fa-video me-1"></i> Camera active! Scanned barcode will be added directly to cart.';
                }
            }).catch(err => {
        ...
        function populateCustomDropdown(dropdownId, hiddenInputId, items, valueKey, labelKey, defaultText = "Select", defaultVal = "") {
            ...
            let html = `<div class="select-option-item ${hiddenInput.value === '' ? 'active' : ''}" data-value="" data-label="Select" onclick="selectCustomDropdownItem('${dropdownId}', '${hiddenInputId}', '', 'Select')">
                <span>Select</span>
        ...
        function resetCustomDropdown(dropdownId, hiddenInputId, defaultText = "Select", defaultVal = "") {
            const dropdown = document.getElementById(dropdownId);
            if (!dropdown) return;
            const hiddenInput = document.getElementById(hiddenInputId);
            const triggerText = dropdown.querySelector('.selected-text');
        ...
        async function openQuickAddProductModal() {
            ...
            resetCustomDropdown('quickCategoryDropdown', 'quickCategorySelect', 'Select', '');
            resetCustomDropdown('quickBrandDropdown', 'quickBrandSelect', 'Select', '');
        ...
        async function loadQuickProductOptions() {
            try {
                ...
                populateCustomDropdown('quickCategoryDropdown', 'quickCategorySelect', quickCategoriesList, 'id', 'category_name', 'Select', '');
                populateCustomDropdown('quickBrandDropdown', 'quickBrandSelect', quickBrandsList, 'id', 'name', 'Select', '');
