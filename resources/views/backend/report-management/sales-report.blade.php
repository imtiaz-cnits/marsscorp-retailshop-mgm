        ...
        <div class="page-content">
          ...
          <div class="bredcam">
            <div class="bredcam-title">
              <a class="bredcam-invoice" href="#">Sales Report List</a>
            </div>
          </div>
...
{{-- <script>
    ...
    try {
        ...
        // Make the API request with optional date filters
        ...
        // Loop through the response data to populate the table and calculate totals
        res.data['SalesReportData'].forEach(function (item, index) {
            costAmountTotal += parseFloat(item['total_cost']) || 0;
            subtotalTotal += parseFloat(item['sub_total']) || 0;
            ...
            let row = `
                <tr>
                    ...
                    <td>${parseFloat(item['return_amount']).toFixed(2)}</td>
                </tr>`;
    ...
    async function salesreportgetList(startDate = '', endDate = '') {
        try {
            ...
            $("#totalCounts").html(`
                <th colspan="2">Total</th>
                <th>${costAmountTotal.toFixed(2)}</th>
                <th>${SellingPriceTotal.toFixed(2)}</th>
                <th>${paidAmountTotal.toFixed(2)}</th>
                <th>${dueAmountTotal.toFixed(2)}</th>
                <th>${ReturnAmountTotal.toFixed(2)}</th>
            `);
