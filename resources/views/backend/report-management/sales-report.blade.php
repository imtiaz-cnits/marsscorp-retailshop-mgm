...
@section('title', 'Sales Report - MARSS CORPORATION')
@section('content')
...
<script>
    ...
    /* ── Flatpickr Initialization (prev/next month, white weekdays in dark mode) ── */
    ...
    /* ── Apply Quick Filter Date Presets ── */
    ...
    /* ── Fetch Sales Report from API (Logic unchanged) ── */
    async function fetchSalesReport() {
        ...
        try {
            ...
            let res = await axios.get("/api/sales-report-list", {
    ...
    /* ── Direct PDF Download: Full width table, dark crisp headers matching Print view ── */
    ...
    /* ── Print Table View: A4 10px margins, header, summary bar, signatures ── */
