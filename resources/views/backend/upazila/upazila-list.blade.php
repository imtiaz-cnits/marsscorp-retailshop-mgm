    ...
    <script>
        ...
        async function getList() {
            try {
                ...
                let res = await axios.get("/api/upazila-list", HeaderToken()); // Fetch expense list
                ...
                res.data['UpazilasData'].forEach(function (item, index) {
                    // Increment subtotal
                    ...
                    let row = `
                        <tr data-row="${index + 1}">
                            <td>${index + 1}</td>
                             <td>${item.district?.district_name || 'N/A'}</td> <!-- Show district_name -->
