    ...
    function renderPaginatedList() {
        ...
        if (pageItems.length === 0) {
            ...
            pageItems.forEach(function(item, idx) {
                ...
                let logo = item.logo ? (item.logo.startsWith('http') ? item.logo : '/' + item.logo.replace(/^\/+/, '')) : "{ asset('backend/assets/img/brand-defult-img.svg') }";
                ...
                let row = `
                    <tr data-row="${realIndex + 1}">
                        ...
                        <td class="text-center">
                            <img style="width: 45px; height: 45px; object-fit: contain;" class="rounded-3 border shadow-sm p-1 bg-white" alt="${item.name}" src="${logo}" onerror="this.src='{ asset('backend/assets/img/brand-defult-img.svg') }'">
                        </td>
                        <td class="text-start">
                ...
                let mobileCard = `
                    <div class="brand-mobile-card card border shadow-sm rounded-4 mb-3 p-3 position-relative bg-white">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-2">
                            <img src="${logo}" class="rounded-3 border shadow-sm p-1 bg-white" style="width: 48px; height: 48px; object-fit: contain;" onerror="this.src='{ asset('backend/assets/img/brand-defult-img.svg') }'">
                            <div>
