    ...
    <script>
        ...
        async function getList() {
            try {
                ...
                let res = await axios.get("/api/thana-list", HeaderToken()); // Fetch expense list
                ...
                res.data['ThanaData'].forEach(function (item, index) {
                    // Increment subtotal
                    ...
                    let row = `
                        <tr data-row="${index + 1}">
                           ...
                           <td>${item.upazila?.upazila_name || 'N/A'}</td>
